...
import { CurrencyDollarIcon, EnvelopeIcon, EyeIcon, EyeSlashIcon, TagIcon } from '@heroicons/react/24/outline'
...
const SendModal = ({ open, setOpen }) => {
  ...
  const submit = async (data) => {
    ...
    const url = `/api/v1/transactions/send`;
    const formData = data;
    formData.type = type;
  ...
  return (
    <Modal open={open} setOpen={setOpen} title="Enviar fondos" className="grid grid-cols-1 gap-6">
      <header className="grid grid-cols-1 items-center relative gap-4">
        ...
        <div className="grid grid-cols-3 items-center">
          <span className="font-medium text-center text-xs sm:text-sm">Destinatario</span>
          ...
          <>
            <div className="border dark:border-gray-500 rounded-lg flex flex-col">
              ...
              <div className="flex justify-between items-center p-3 border-t dark:border-gray-500">
                <span className="text-gray-400 text-sm">El beneficiario recibe</span>
...
const RequestModal = ({ open, setOpen }) => {
  return (
    <Modal open={open} setOpen={setOpen} title="Solicitar fondos">
...
export const BalanceCard = ({ balance = 0 }) => {
  ...
  return (
    ...
    >
      ...
      <SendModal open={sendModal} setOpen={setSendModal} />
      <RequestModal open={requestModal} setOpen={setRequestModal} />
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 font-medium text-sm">
        ...
        <button className="flex flex-col items-center gap-1" onClick={() => setSendModal(!sendModal)}>
          <div className="bg-green-600 hover:bg-green-600/70 transition-colors ease-in-out rounded-xl flex justify-center p-1 w-full shadow-lg brightness-90">
            <ArrowTurnUpRightIcon className="size-6" />
          </div>
          <span>Enviar</span>
        </button>
        <button className="flex flex-col items-center gap-1" onClick={() => setRequestModal(!requestModal)}>
          <div className="bg-green-600 hover:bg-green-600/70 transition-colors ease-in-out rounded-xl flex justify-center p-1 w-full shadow-lg brightness-90">
